...
namespace SurvivalFPS.Core.Audio
{
    ...
    public class AudioManager : SingletonBehaviour<AudioManager>
    {
        ...
        protected IEnumerator _setGroupVolumeRoutine(string name, float volume, float fadeTime)
        {
        ...
        protected ulong ConfigurePoolObject(int poolIndex, string groupName, AudioClip clip, Vector3 position, float volume, float spatialBlend, float unimportance)
        {
        ...
        /// <summary>
        /// Stops the audio source and makes its pool item available in the pool after the specified time
        /// </summary>
        ...
        protected IEnumerator _stopSoundDelayedRoutine(ulong id, float duration)
        {
